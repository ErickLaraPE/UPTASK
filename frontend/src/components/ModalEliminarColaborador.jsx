...
const ModalEliminarColaborador = () => {
    ...
    const {modalEliminarColaborador,handleModalEliminarColaborador,eliminarColaborador,proyecto} = useProyectos()
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div className='mt-2 '>
                                        <p className='text-sm text-gray-500'>
                                            Una vez eliminado, no podras acceder al proyecto.
                                        </p>
                                    </div>
