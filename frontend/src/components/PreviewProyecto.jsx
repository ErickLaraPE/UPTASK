...
const PreviewProyecto = ({proyecto}) => {
    const { auth } = useAuth() // estado para saber si el usuario logueado es el creador
    // si no lo es se le muestra como colaborador.
    const { nombre, _id, cliente, creador } = proyecto //prop de proyecto
