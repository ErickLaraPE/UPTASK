...
const Proyecto = () => {
    ...
    const {obtenerProyecto,proyecto,cargando,handleModalTarea,alerta,submitTareasProyecto,eliminarTareaProyecto,actualizarTareaProyecto,completarTareaProyecto} = useProyectos()
        ...
        <>
            ...
            >   
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" 
                    clipRule="evenodd" />
                </svg>
                Nueva Tarea
            </button>
            ...
            <div className="bg-white shadow mt-10 rounded-lg">
                ...
                <p className="text-center my-5 p-10">No hay colaboradores
                 en este proyecto</p>}
            </div>
            )}
